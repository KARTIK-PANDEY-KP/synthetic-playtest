...
export const OBJECTS = {
  ...
  greenhouse: [obj('return', 'Transit concourse', 0, 6.6, 'door'), obj('grow_log', 'Read botanical care notice', -5.8, 4.8, 'log'), ...Array.from({ length: 12 }, (_, i) => obj(`plant_${i}`, 'Irrigate specimen', -4.5 + (i % 4) * 3, -4 + Math.floor(i / 4) * 3, 'plant', { y: .9, w: .9, h: 1.4 })), obj('bio_cell', 'Collect bioelectric cell', 5.8, 4.5, 'pickup', { y: 1, w: .6, h: .7 })],
